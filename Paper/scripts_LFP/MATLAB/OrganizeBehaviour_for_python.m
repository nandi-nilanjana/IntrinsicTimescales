...
%addpath('/hpc/comco/l/ephy_laminar_LFP/Raw_data/');
addpath('/envau/work/comco/nandi.n/IntrinsicTimescales/Paper/docs');
...
% monkey_name = 'Mourad';
% %fnames = [{'Mo180328001'},{'Mo180330001'},{'Mo180405001'},{'Mo180405004'},{'Mo180411001'},{'Mo180412002'},{'Mo180418002'},{'Mo180419003'},{'Mo180426004'},{'Mo180503002'},{'Mo180523002'},{'Mo180524003'},{'Mo180525003'},{'Mo180531002'},{'Mo180614002'},{'Mo180614006'},{'Mo180615002'},{'Mo180615005'},{'Mo180619002'},{'Mo180620004'},{'Mo180622002'},{'Mo180626003'},{'Mo180627003'},{'Mo180629005'},{'Mo180703003'},{'Mo180704003'},{'Mo180705002'},{'Mo180706002'},{'Mo180710002'},{'Mo180711004'},{'Mo180712006'}];

monkey_name  = 'Tomy';
fnames = [{'t140924003'},{'t140925001'},{'t140926002'},{'t140930001'},{'t141001001'},{'t141008001'},{'t141010003'},{'t150122001'},{'t150123001'},{'t150204001'},{'t150205004'},{'t150303002'},{'t150319003'},{'t150320002'},{'t150327002'},{'t150327003'},{'t150415002'},{'t150416002'},{'t150423002'},{'t150430002'},{'t150520003'},{'t150716001'},{'t150702002'}];


  probes = [1,2];
  % set where the data matrices are stored
  %saveFolder = ['/envau/work/comco/nandi.n/LFP_timescales/RAWData/' monkey_name '/LFPmat'];
  saveFolder = ['/envau/work/comco/nandi.n/IntrinsicTimescales/Paper/data/LFP/' monkey_name '/RAW']; %modified for paper by including new sessions, bad channels and elitrials
...
for i=1:length(fnames)
    ...
    for j=1:length(probes)
        ...
        monkey_info_laminar = readtable('ephydataset_info.txt', 'NumHeaderLines',0);
        %selected_session_laminar = strcmp(monkey_info_laminar.x_SESSION, fname);
        selected_session_laminar = strcmp(monkey_info_laminar.SESSION, fname);
        ...
        elitrials_total = [elitrials elitrials_laminar]; %taking elitrals_laminar into account since Feb 28,2025
